...
case class User(id:Int,user:String, password:String,nickname:String,role:Option[String]) 


object User extends  ((Int,String ,String,String,Option[String]) => User) {

  def apply(user:String,password:String,nickname:String,role:Option[String]):User = User(0,user,password,nickname,role)
  def unpick(u: User): Option[ (Int,String,String,String,Option[String])]  = Some(u.id,u.user,u.password,u.nickname,u.role)
